...
class AccountApi:
    ...
    @validate_call
    async def clear_cache_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def clear_cache_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _clear_cache_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/accounts/me/cache',
    ...
    async def reset_me(
        self,
        reset_account_request: Optional[ResetAccountRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param reset_account_request:
        :type reset_account_request: ResetAccountRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._reset_me_serialize(
    ...
    @validate_call
    async def reset_me_with_http_info(
        self,
        reset_account_request: Optional[ResetAccountRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def reset_me_without_preload_content(
        self,
        reset_account_request: Optional[ResetAccountRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _reset_me_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if reset_account_request is not None:
            _body_params = reset_account_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounts/me/reset',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
