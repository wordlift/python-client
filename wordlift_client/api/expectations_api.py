...
class ExpectationsApi:
    ...
    @validate_call
    async def list_segment_expectations_accounts_account_id_monitoring_segments_segment_id_expectations_get(
        self,
        segment_id: StrictStr,
        account_id: StrictStr,
        expectation_id: Annotated[Optional[List[StrictStr]], Field(description="Filter to these expectation ids (repeatable). Omitted returns every expectation attached to the segment.")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="Opaque pagination cursor from a previous response.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Maximum number of expectations to return.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param account_id: (required)
        :type account_id: str
        :param expectation_id: Filter to these expectation ids (repeatable). Omitted returns every expectation attached to the segment.
        :type expectation_id: List[str]
        :param cursor: Opaque pagination cursor from a previous response.
        :type cursor: str
        :param limit: Maximum number of expectations to return.
        :type limit: int
        ...
        _param = self._list_segment_expectations_accounts_account_id_monitoring_segments_segment_id_expectations_get_serialize(
            segment_id=segment_id,
            account_id=account_id,
            expectation_id=expectation_id,
            cursor=cursor,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListExpectationSeverityResponse",
            '422': "MonitorHTTPValidationError",
        }
        response_data = await self.api_client.call_api(
            *_param,
    ...
    @validate_call
    async def list_segment_expectations_accounts_account_id_monitoring_segments_segment_id_expectations_get_with_http_info(
        self,
        segment_id: StrictStr,
        account_id: StrictStr,
        expectation_id: Annotated[Optional[List[StrictStr]], Field(description="Filter to these expectation ids (repeatable). Omitted returns every expectation attached to the segment.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListExpectationSeverityResponse]:
        """List Segment Expectations
    ...
    @validate_call
    async def list_segment_expectations_accounts_account_id_monitoring_segments_segment_id_expectations_get_without_preload_content(
        self,
        segment_id: StrictStr,
        account_id: StrictStr,
        expectation_id: Annotated[Optional[List[StrictStr]], Field(description="Filter to these expectation ids (repeatable). Omitted returns every expectation attached to the segment.")] = None,
    ...
    def _list_segment_expectations_accounts_account_id_monitoring_segments_segment_id_expectations_get_serialize(
        self,
        segment_id,
        account_id,
        expectation_id,
        ...
        if expectation_id is not None:
            ...
            _query_params.append(('expectation_id', expectation_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{account_id}/monitoring/segments/{segment_id}/expectations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
