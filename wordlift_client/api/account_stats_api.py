...
class AccountStatsApi:
    ...
    async def get_my_stats(
        ...
        _param = self._get_my_stats_serialize(
    ...
    @validate_call
    async def get_my_stats_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_my_stats_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_my_stats_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/me/stats',
