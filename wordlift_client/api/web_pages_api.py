...
class WebPagesApi:
    ...
    async def get_web_page(
        self,
        url: Annotated[StrictStr, Field(description="Url to extract")],
    ...
    @validate_call
    async def get_web_page_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="Url to extract")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_web_page_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="Url to extract")],
        _request_timeout: Union[
            None,
