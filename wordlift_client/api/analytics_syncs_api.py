...
class AnalyticsSyncsApi:
    ...
    async def create_analytics_sync(
        ...
        _param = self._create_analytics_sync_serialize(
    ...
    @validate_call
    async def create_analytics_sync_with_http_info(
        self,
        analytics_sync_request: AnalyticsSyncRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_analytics_sync_without_preload_content(
        self,
        analytics_sync_request: AnalyticsSyncRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_analytics_sync_serialize(
        self,
