...
class MonitorCheckSummaryApi:
    ...
    @validate_call
    async def list_check_summary_by_check_accounts_account_id_monitoring_checks_summary_by_check_get(
        self,
        ...
        :type account_id: str
        :param check_name: Filter by check name (repeatable), or the reserved value `overall` to match only the all-checks-combined aggregate row. Omitted returns every check together with that aggregate.
        ...
        _param = self._list_check_summary_by_check_accounts_account_id_monitoring_checks_summary_by_check_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCheckSummaryByCheckResponse",
    ...
    @validate_call
    async def list_check_summary_by_check_accounts_account_id_monitoring_checks_summary_by_check_get_with_http_info(
        self,
        account_id: StrictStr,
        check_name: Annotated[Optional[List[CheckNameFilterValue]], Field(description="Filter by check name (repeatable), or the reserved value `overall` to match only the all-checks-combined aggregate row. Omitted returns every check together with that aggregate.")] = None,
        segment_id: Annotated[Optional[List[StrictStr]], Field(description="Filter by segment id (repeatable), or the reserved value `overall` to match only the account-wide aggregate row. Omitted returns every segment together with that aggregate.")] = None,
    ...
    @validate_call
    async def list_check_summary_by_check_accounts_account_id_monitoring_checks_summary_by_check_get_without_preload_content(
        self,
        account_id: StrictStr,
        check_name: Annotated[Optional[List[CheckNameFilterValue]], Field(description="Filter by check name (repeatable), or the reserved value `overall` to match only the all-checks-combined aggregate row. Omitted returns every check together with that aggregate.")] = None,
        segment_id: Annotated[Optional[List[StrictStr]], Field(description="Filter by segment id (repeatable), or the reserved value `overall` to match only the account-wide aggregate row. Omitted returns every segment together with that aggregate.")] = None,
    ...
    def _list_check_summary_by_check_accounts_account_id_monitoring_checks_summary_by_check_get_serialize(
        self,
        account_id,
        check_name,
        segment_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{account_id}/monitoring/checks/summary/by-check',
