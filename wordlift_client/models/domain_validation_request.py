...
class DomainValidationRequest(BaseModel):
    ...
    """ # noqa: E501
    dataset_domain: StrictStr = Field(description="The dataset domain, e.g. data.example.org")
    dataset_name: StrictStr = Field(description="The dataset name, e.g. my-dataset-name")
    __properties: ClassVar[List[str]] = ["dataset_domain", "dataset_name"]
