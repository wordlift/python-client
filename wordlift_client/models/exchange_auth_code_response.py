...
class ExchangeAuthCodeResponse(BaseModel):
    ...
    expires_in: Optional[StrictInt] = Field(default=None, description="The number of seconds for the access token to expire")
    ...
    token_type: Optional[StrictStr] = Field(default=None, description="The token type, usually Bearer")
