...
class EntityMatch(BaseModel):
    ...
    Entity Match
    """ # noqa: E501
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence score for the current entity.")
    entity_id: Optional[StrictStr] = Field(default=None, description="The entity URI.", alias="entityId")
    __properties: ClassVar[List[str]] = ["confidence", "entityId"]
