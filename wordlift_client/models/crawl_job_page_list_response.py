...
class CrawlJobPageListResponse(BaseModel):
    """
    CrawlJobPageListResponse
    """ # noqa: E501
    items: List[CrawlJobPageSummary] = Field(description="Page summaries for this crawl job.")
    page: CrawlJobListPaginationInfo
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CrawlJobPageSummary.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "page": CrawlJobListPaginationInfo.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
