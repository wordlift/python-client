...
class ExpectationSummaryByTypeItem(BaseModel):
    """
    ExpectationSummaryByTypeItem
    """ # noqa: E501
    segment_id: Optional[StrictStr]
    expectation_type: ExpectationType
    monitor_count: StrictInt
    expectation_count: StrictInt
    stats: List[ExpectationSummaryTypeStat]
    __properties: ClassVar[List[str]] = ["segment_id", "expectation_type", "monitor_count", "expectation_count", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monitor_count": obj.get("monitor_count"),
            "expectation_count": obj.get("expectation_count"),
            "stats": [ExpectationSummaryTypeStat.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
