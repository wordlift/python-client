...
class PageArtifactQueryRequest(BaseModel):
    """
    PageArtifactQueryRequest
    """ # noqa: E501
    items: Annotated[List[PageArtifactQueryItem], Field(min_length=1)]
    run_id: Optional[StrictStr] = None
    as_of: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["items", "run_id", "as_of"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PageArtifactQueryItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
