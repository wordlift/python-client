...
class SmartContentProject(BaseModel):
    """
    ...
    quantity: Optional[StrictStr] = Field(default=None, description="The type of the Smart Content - single or bulk.")
    __properties: ClassVar[List[str]] = ["account_id", "created_at", "id", "model_id", "name", "quantity"]
