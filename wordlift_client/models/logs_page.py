...
class LogsPage(BaseModel):
    ...
    limit: StrictInt
    total: StrictInt
    __properties: ClassVar[List[str]] = ["items", "offset", "limit", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [LogEntryResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
