...
class WebsitePageListResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [WebsitePageSummary.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "page": PaginationInfo.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
