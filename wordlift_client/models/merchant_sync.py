...
class MerchantSync(BaseModel):
    ...
    products_in_kg_after_sync: Optional[StrictInt] = Field(default=None, description="The number of products present in the KG after syncing.")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "error_reason", "has_errors", "id", "merchant_id", "modified_at", "products_created", "products_deleted", "products_errored", "products_in_kg_after_sync", "products_skipped", "products_total", "products_unchanged", "products_updated", "started_at", "stopped_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products_in_kg_after_sync": obj.get("products_in_kg_after_sync"),
