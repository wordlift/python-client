...
class ListExpectationSummaryByExpectationResponse(BaseModel):
    """
    ListExpectationSummaryByExpectationResponse
    """ # noqa: E501
    items: List[ExpectationSummaryByExpectationItem]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ExpectationSummaryByExpectationItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
