...
class SiteFilesBotAccess(BaseModel):
    """
    SiteFilesBotAccess
    """ # noqa: E501
    gptbot: Optional[StrictStr] = None
    claude: Optional[StrictStr] = None
    googlebot: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["gptbot", "claude", "googlebot"]

    @field_validator('gptbot')
    def gptbot_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def claude_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def googlebot_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gptbot": obj.get("gptbot"),
            "claude": obj.get("claude"),
            "googlebot": obj.get("googlebot")
        })
        return _obj
