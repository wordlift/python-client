...
class WebsitePageSummary(BaseModel):
    """
    WebsitePageSummary
    """ # noqa: E501
    page_id: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["page_id", "host", "run_id", "last_crawled_at", "status", "url_requested", "url_final", "canonical_url", "status_code"]
