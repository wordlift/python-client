...
class LongtailResponse(BaseModel):
    ...
    entities: Optional[List[LongTailEntity]] = Field(default=None, description="The list of entities matching the query.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": [LongTailEntity.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None
        })
        return _obj
