...
class BuildAuthorizeUriRequest(BaseModel):
    """
    The request of the `buildAuthorizeUri` endpoint.
    """ # noqa: E501
    redirect_uri: StrictStr = Field(description="The Redirect URI to where redirect the Client after successful authentication.")
