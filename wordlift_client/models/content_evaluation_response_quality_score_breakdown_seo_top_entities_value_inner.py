...
class ContentEvaluationResponseQualityScoreBreakdownSeoTopEntitiesValueInner(BaseModel):
    """
    ContentEvaluationResponseQualityScoreBreakdownSeoTopEntitiesValueInner
    """ # noqa: E501
    text: StrictStr
    count: StrictInt
    __properties: ClassVar[List[str]] = ["text", "count"]
