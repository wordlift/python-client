...
class ContentEvaluationResponseMetadataSentiment(BaseModel):
    """
    ContentEvaluationResponseMetadataSentiment
    """ # noqa: E501
    polarity: Union[StrictFloat, StrictInt]
    subjectivity: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["polarity", "subjectivity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subjectivity": obj.get("subjectivity")
        })
        return _obj
