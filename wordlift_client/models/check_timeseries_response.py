...
class CheckTimeseriesResponse(BaseModel):
    """
    CheckTimeseriesResponse
    """ # noqa: E501
    check_name: StrictStr
    items: List[CheckResultItem]
    __properties: ClassVar[List[str]] = ["check_name", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [CheckResultItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
