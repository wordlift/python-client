...
class ContentEvaluationResponseQualityScore(BaseModel):
    """
    ContentEvaluationResponseQualityScore
    """ # noqa: E501
    overall: Union[StrictFloat, StrictInt] = Field(description="The overall quality score.")
    breakdown: ContentEvaluationResponseQualityScoreBreakdown
    __properties: ClassVar[List[str]] = ["overall", "breakdown"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": ContentEvaluationResponseQualityScoreBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None
        })
        return _obj
