...
class UpdateSiteUrlRequest(BaseModel):
    """
    ...
    def site_url_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(https?:\/\/|sc-domain:)\S+", value):
            raise ValueError(r"must validate the regular expression /^(https?:\/\/|sc-domain:)\S+/")
        return value
