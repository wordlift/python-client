...
class CrawlJobListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[CrawlJobSummary] = Field(description="List of crawl jobs ordered by newest first.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CrawlJobSummary.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
