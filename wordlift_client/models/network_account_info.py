...
class NetworkAccountInfo(BaseModel):
    """
    Network Account Information
    """ # noqa: E501
    account_id: Optional[StrictInt] = Field(default=None, description="The Account Id", alias="accountId")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "datasetId", "datasetUri", "url"]
