...
class UpdateRecordRequest(BaseModel):
    ...
    has_upvote: StrictBool = Field(description="Whether the user upvoted the completion.")
    id: StrictInt
    is_accepted: StrictBool = Field(description="Whether the completion is accepted by the user.")
    __properties: ClassVar[List[str]] = ["completion", "has_upvote", "id", "is_accepted"]
