...
class ListExpectationSummaryByTypeResponse(BaseModel):
    """
    ListExpectationSummaryByTypeResponse
    """ # noqa: E501
    items: List[ExpectationSummaryByTypeItem]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ExpectationSummaryByTypeItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
