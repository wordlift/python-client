...
class ExpectationSummaryByExpectationItem(BaseModel):
    """
    ExpectationSummaryByExpectationItem
    """ # noqa: E501
    segment_id: Optional[StrictStr]
    expectation_id: StrictStr
    stats: List[ExpectationSummaryOutcomeStat]
    __properties: ClassVar[List[str]] = ["segment_id", "expectation_id", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [ExpectationSummaryOutcomeStat.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
