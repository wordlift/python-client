...
class CrawlJobListPaginationInfo(BaseModel):
    """
    CrawlJobListPaginationInfo
    """ # noqa: E501
    offset: StrictInt = Field(description="Zero-based list offset.")
    limit: StrictInt = Field(description="Maximum number of items requested.")
    total: StrictInt = Field(description="Total number of matching crawl jobs.")
