...
class DiagnosticPlugin(BaseModel):
    """
    Plugin Data used for diagnostics
    """ # noqa: E501
    account_id: Optional[StrictInt] = Field(default=None, description="The account id.")
    active: Optional[StrictBool] = Field(default=None, description="Whether the plugin is active.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The plugin name.")
    version: Optional[StrictStr] = Field(default=None, description="The plugin version.")
    __properties: ClassVar[List[str]] = ["account_id", "active", "created_at", "id", "name", "version"]
