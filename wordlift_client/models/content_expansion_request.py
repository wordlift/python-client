...
class ContentExpansionRequest(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The target URL.")
    entities: List[StrictStr] = Field(description="A list of entity labels.")
    openai_key: StrictStr = Field(description="The OpenAI key.")
    __properties: ClassVar[List[str]] = ["url", "entities", "openai_key"]
