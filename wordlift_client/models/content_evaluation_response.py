...
class ContentEvaluationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["quality_score", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quality_score": ContentEvaluationResponseQualityScore.from_dict(obj["quality_score"]) if obj.get("quality_score") is not None else None,
            "metadata": ContentEvaluationResponseMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
