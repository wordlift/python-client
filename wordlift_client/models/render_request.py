...
class RenderRequest(BaseModel):
    ...
    """ # noqa: E501
    data: Dict[str, Any] = Field(description="The data from knowledge graph after applying the graphql query.")
    template: StrictStr = Field(description="The liquid template.")
