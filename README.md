...
*PlatformConsumptionsApi* | [**delete_platform_consumption**](docs/PlatformConsumptionsApi.md#delete_platform_consumption) | **DELETE** /platform-limit/consumptions/{id} | Delete Platform Consumption
