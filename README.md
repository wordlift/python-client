...
*JobsApi* | [**create_job_kpis_graphs_graph_id_jobs_post**](docs/JobsApi.md#create_job_kpis_graphs_graph_id_jobs_post) | **POST** /kpis/graphs/{graph_id}/jobs | Create Job
*JobsApi* | [**get_job_kpis_graphs_graph_id_jobs_job_id_get**](docs/JobsApi.md#get_job_kpis_graphs_graph_id_jobs_job_id_get) | **GET** /kpis/graphs/{graph_id}/jobs/{job_id} | Get Job
*SnapshotsApi* | [**get_snapshot_kpis_graphs_graph_id_snapshots_date_get**](docs/SnapshotsApi.md#get_snapshot_kpis_graphs_graph_id_snapshots_date_get) | **GET** /kpis/graphs/{graph_id}/snapshots/{date} | Get Snapshot
*SnapshotsApi* | [**list_snapshots_kpis_graphs_graph_id_snapshots_get**](docs/SnapshotsApi.md#list_snapshots_kpis_graphs_graph_id_snapshots_get) | **GET** /kpis/graphs/{graph_id}/snapshots | List Snapshots
