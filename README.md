...
*SearchAnalyticsSynchronizationsApi* | [**create_sync1**](docs/SearchAnalyticsSynchronizationsApi.md#create_sync1) | **POST** /analytics-syncs | Create analytics sync.
*SearchAnalyticsSynchronizationsApi* | [**list_analytics_syncs**](docs/SearchAnalyticsSynchronizationsApi.md#list_analytics_syncs) | **GET** /analytics-syncs | Get the latest syncs
