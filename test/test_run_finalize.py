...
class TestRunFinalize(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RunFinalize:
        """Test RunFinalize
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunFinalize`
        """
        model = RunFinalize()
        if include_optional:
            return RunFinalize(
