...
# **update_record**
> Record update_record(content_generation_id, record_id, content_generation_request)
...
async with wordlift_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update
        api_response = await api_instance.update_record(content_generation_id, record_id, content_generation_request)
