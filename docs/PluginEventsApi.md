...
# **create_event**
> Event create_event(events_request)
...
async with wordlift_client.ApiClient(configuration) as api_client:
    ...
    events_request = wordlift_client.EventsRequest() # EventsRequest | 

    try:
        # Create
        api_response = await api_instance.create_event(events_request)
...
------------- | ------------- | ------------- | -------------
 **events_request** | [**EventsRequest**](EventsRequest.md)|  | 
...
# **list_events**
> EventsResponse list_events(url=url, date_greater_than=date_greater_than, date_less_than=date_less_than, cursor=cursor, limit=limit)
