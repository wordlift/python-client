...
[**delete_platform_consumption**](PlatformConsumptionsApi.md#delete_platform_consumption) | **DELETE** /platform-limit/consumptions/{id} | Delete Platform Consumption
...
> delete_platform_consumption(id)
...
async with wordlift_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Platform Consumption
        await api_instance.delete_platform_consumption(id)
    except Exception as e:
