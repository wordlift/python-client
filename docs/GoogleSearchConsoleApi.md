...
------------- | ------------- | -------------
[**create_url_inspection**](GoogleSearchConsoleApi.md#create_url_inspection) | **POST** /gsc/url-inspections | Create
...
# **create_url_inspection**
> str create_url_inspection(create_url_inspection_request)
...
async with wordlift_client.ApiClient(configuration) as api_client:
    ...
    create_url_inspection_request = wordlift_client.CreateUrlInspectionRequest() # CreateUrlInspectionRequest | 

    try:
        # Create
        api_response = await api_instance.create_url_inspection(create_url_inspection_request)
        print("The response of GoogleSearchConsoleApi->create_url_inspection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GoogleSearchConsoleApi->create_url_inspection: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **create_url_inspection_request** | [**CreateUrlInspectionRequest**](CreateUrlInspectionRequest.md)|  | 
