# wordlift_client.AiVisibilityApi

All URIs are relative to *https://api.wordlift.io*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_ai_visibility_audit**](AiVisibilityApi.md#create_ai_visibility_audit) | **POST** /ai-visibility-audits | Create AI visibility audits for Query Fan-Out
...
async with wordlift_client.ApiClient(configuration) as api_client:
    ...
    api_instance = wordlift_client.AiVisibilityApi(api_client)
    ...
    try:
        ...
        print("The response of AiVisibilityApi->create_ai_visibility_audit:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AiVisibilityApi->create_ai_visibility_audit: %s\n" % e)
```
